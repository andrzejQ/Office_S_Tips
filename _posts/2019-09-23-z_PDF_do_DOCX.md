...
Uwaga:
* W Wordzie wybieraj format pliku ***.DOCX** a nie *.DOC czy *.RTF. Inaczej pliki wynikowe mogą okazać się ogromne (choć jest na to rada - zob. [Problem ogromnego rozmiaru plików RTF i DOC]({% post_url 2019-09-20-drobne_podpowiedzi_2 %}#problem-ogromnego-rozmiaru-plików-rtf-i-doc))
