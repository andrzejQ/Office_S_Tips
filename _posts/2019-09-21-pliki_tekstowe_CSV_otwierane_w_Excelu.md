...
3. Wszelkie **teksty ujęte w cudzysłowy "..."** nawet zawierające wewnątrz znak dowolnego separatora czy nowego wiersza (!) są umieszczane w jednej komórce, a zewnętrzne cudzysłowy są pomijane. <small>Jednak znaki nowego wiersza potrafią powodować kłopoty  nawet pomimo poprawnych cudzysłowów - w przypadku importu danych z pliku tekstowego w Excelu każdy wiersz jest traktowany osobno i dane się źle przyporządkowują do kolumn!</small>
